...
static const char* CMockString_InyectorControlAct_onIdleSpeed = "InyectorControlAct_onIdleSpeed";
static const char* CMockString_InyectorControlAct_onNormal = "InyectorControlAct_onNormal";
...
typedef struct _CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE
{
  UNITY_LINE_TYPE LineNumber;
  Event* Expected_event;
  int IgnoreArg_event;

} CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE;

typedef struct _CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE
{
  UNITY_LINE_TYPE LineNumber;
  Event* Expected_event;
  int IgnoreArg_event;

} CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE;
...
static struct Mock_InyectorControlActInstance
{
  ...
  int InyectorControlAct_onIdleSpeed_IgnoreBool;
  CMOCK_InyectorControlAct_onIdleSpeed_CALLBACK InyectorControlAct_onIdleSpeed_CallbackFunctionPointer;
  int InyectorControlAct_onIdleSpeed_CallbackCalls;
  CMOCK_MEM_INDEX_TYPE InyectorControlAct_onIdleSpeed_CallInstance;
  int InyectorControlAct_onNormal_IgnoreBool;
  CMOCK_InyectorControlAct_onNormal_CALLBACK InyectorControlAct_onNormal_CallbackFunctionPointer;
  int InyectorControlAct_onNormal_CallbackCalls;
  CMOCK_MEM_INDEX_TYPE InyectorControlAct_onNormal_CallInstance;
...
void Mock_InyectorControlAct_Verify(void)
{
  ...
  if (Mock.InyectorControlAct_init_CallbackFunctionPointer != NULL)
    Mock.InyectorControlAct_init_CallInstance = CMOCK_GUTS_NONE;
  if (Mock.InyectorControlAct_onIdleSpeed_IgnoreBool)
    Mock.InyectorControlAct_onIdleSpeed_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_onIdleSpeed);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.InyectorControlAct_onIdleSpeed_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.InyectorControlAct_onIdleSpeed_CallbackFunctionPointer != NULL)
    Mock.InyectorControlAct_onIdleSpeed_CallInstance = CMOCK_GUTS_NONE;
  if (Mock.InyectorControlAct_onNormal_IgnoreBool)
    Mock.InyectorControlAct_onNormal_CallInstance = CMOCK_GUTS_NONE;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_onNormal);
  UNITY_TEST_ASSERT(CMOCK_GUTS_NONE == Mock.InyectorControlAct_onNormal_CallInstance, cmock_line, CMockStringCalledLess);
  if (Mock.InyectorControlAct_onNormal_CallbackFunctionPointer != NULL)
    Mock.InyectorControlAct_onNormal_CallInstance = CMOCK_GUTS_NONE;
...
void Mock_InyectorControlAct_Destroy(void)
{
  ...
  Mock.InyectorControlAct_onIdleSpeed_CallbackFunctionPointer = NULL;
  Mock.InyectorControlAct_onIdleSpeed_CallbackCalls = 0;
  Mock.InyectorControlAct_onNormal_CallbackFunctionPointer = NULL;
  Mock.InyectorControlAct_onNormal_CallbackCalls = 0;
...
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE* cmock_call_instance;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_onIdleSpeed);
  cmock_call_instance = (CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_onIdleSpeed_CallInstance);
  Mock.InyectorControlAct_onIdleSpeed_CallInstance = CMock_Guts_MemNext(Mock.InyectorControlAct_onIdleSpeed_CallInstance);
  if (Mock.InyectorControlAct_onIdleSpeed_IgnoreBool)
  {
    UNITY_CLR_DETAILS();
    return;
  ...
  {
    UNITY_SET_DETAILS(CMockString_InyectorControlAct_onIdleSpeed,CMockString_event);
    UNITY_TEST_ASSERT_EQUAL_PTR(cmock_call_instance->Expected_event, event, cmock_line, CMockStringMismatch);
  }
  if (Mock.InyectorControlAct_onIdleSpeed_CallbackFunctionPointer != NULL)
  {
    Mock.InyectorControlAct_onIdleSpeed_CallbackFunctionPointer(event, Mock.InyectorControlAct_onIdleSpeed_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
}

void CMockExpectParameters_InyectorControlAct_onIdleSpeed(CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE* cmock_call_instance, Event* event)
{
...
{
  Mock.InyectorControlAct_onIdleSpeed_IgnoreBool = (int)1;
}

void InyectorControlAct_onIdleSpeed_CMockExpect(UNITY_LINE_TYPE cmock_line, Event* event)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE));
  CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
  memset(cmock_call_instance, 0, sizeof(*cmock_call_instance));
  Mock.InyectorControlAct_onIdleSpeed_CallInstance = CMock_Guts_MemChain(Mock.InyectorControlAct_onIdleSpeed_CallInstance, cmock_guts_index);
  Mock.InyectorControlAct_onIdleSpeed_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  CMockExpectParameters_InyectorControlAct_onIdleSpeed(cmock_call_instance, event);
  UNITY_CLR_DETAILS();
}
...
{
  Mock.InyectorControlAct_onIdleSpeed_IgnoreBool = (int)0;
  Mock.InyectorControlAct_onIdleSpeed_CallbackFunctionPointer = Callback;
}

void InyectorControlAct_onIdleSpeed_CMockIgnoreArg_event(UNITY_LINE_TYPE cmock_line)
{
  CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.InyectorControlAct_onIdleSpeed_CallInstance));
...
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE* cmock_call_instance;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_onNormal);
  cmock_call_instance = (CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_onNormal_CallInstance);
  Mock.InyectorControlAct_onNormal_CallInstance = CMock_Guts_MemNext(Mock.InyectorControlAct_onNormal_CallInstance);
  if (Mock.InyectorControlAct_onNormal_IgnoreBool)
  {
    UNITY_CLR_DETAILS();
    return;
  ...
  if (!cmock_call_instance->IgnoreArg_event)
  {
    UNITY_SET_DETAILS(CMockString_InyectorControlAct_onNormal,CMockString_event);
    UNITY_TEST_ASSERT_EQUAL_PTR(cmock_call_instance->Expected_event, event, cmock_line, CMockStringMismatch);
  }
  if (Mock.InyectorControlAct_onNormal_CallbackFunctionPointer != NULL)
  {
    Mock.InyectorControlAct_onNormal_CallbackFunctionPointer(event, Mock.InyectorControlAct_onNormal_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
}

void CMockExpectParameters_InyectorControlAct_onNormal(CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE* cmock_call_instance, Event* event)
{
  cmock_call_instance->Expected_event = event;
  cmock_call_instance->IgnoreArg_event = 0;
}
...
{
  Mock.InyectorControlAct_onNormal_IgnoreBool = (int)1;
}

void InyectorControlAct_onNormal_CMockExpect(UNITY_LINE_TYPE cmock_line, Event* event)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE));
  CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
  memset(cmock_call_instance, 0, sizeof(*cmock_call_instance));
  Mock.InyectorControlAct_onNormal_CallInstance = CMock_Guts_MemChain(Mock.InyectorControlAct_onNormal_CallInstance, cmock_guts_index);
  Mock.InyectorControlAct_onNormal_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  CMockExpectParameters_InyectorControlAct_onNormal(cmock_call_instance, event);
  UNITY_CLR_DETAILS();
}
...
{
  Mock.InyectorControlAct_onNormal_IgnoreBool = (int)0;
  Mock.InyectorControlAct_onNormal_CallbackFunctionPointer = Callback;
}

void InyectorControlAct_onNormal_CMockIgnoreArg_event(UNITY_LINE_TYPE cmock_line)
{
  CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE*)CMock_Guts_GetAddressFor(CMock_Guts_MemEndOfChain(Mock.InyectorControlAct_onNormal_CallInstance));
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringIgnPreExp);
  cmock_call_instance->IgnoreArg_event = 1;
}
